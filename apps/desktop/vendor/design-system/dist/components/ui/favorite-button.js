...
var favorite_button_exports = {};
__export(favorite_button_exports, {
  FavoriteButton: () => FavoriteButton
});
module.exports = __toCommonJS(favorite_button_exports);
...
function Tooltip({
  ...
  return /* @__PURE__ */ React3.createElement(TooltipProvider, null, /* @__PURE__ */ React3.createElement(import_radix_ui2.Tooltip.Root, { "data-slot": "tooltip", ...props }));
}
function TooltipTrigger({
  ...props
}) {
  return /* @__PURE__ */ React3.createElement(import_radix_ui2.Tooltip.Trigger, { "data-slot": "tooltip-trigger", ...props });
}
function TooltipContent({
  ...
  return /* @__PURE__ */ React3.createElement(import_radix_ui2.Tooltip.Portal, null, /* @__PURE__ */ React3.createElement(
    ...
    children,
    /* @__PURE__ */ React3.createElement(import_radix_ui2.Tooltip.Arrow, { className: "bg-foreground fill-foreground z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]" })
  ));
}
