...
module.exports = __toCommonJS(thinking_block_exports);
...
function ThinkingBlock({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "overflow-hidden rounded-lg border border-amber-500/20 bg-amber-500/5" }, /* @__PURE__ */ React.createElement(
    ...
    expanded ? /* @__PURE__ */ React.createElement(import_lucide_react3.ChevronDown, { className: "size-3.5 text-amber-500/60" }) : /* @__PURE__ */ React.createElement(import_lucide_react3.ChevronRight, { className: "size-3.5 text-amber-500/60" }),
    /* @__PURE__ */ React.createElement(import_lucide_react3.Brain, { className: "size-3.5 text-amber-400/80" }),
