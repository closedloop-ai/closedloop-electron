...
var terminal_block_exports = {};
__export(terminal_block_exports, {
  TerminalBlock: () => TerminalBlock
});
module.exports = __toCommonJS(terminal_block_exports);
...
function TerminalBlock({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "overflow-hidden rounded-xl border border-border/70 bg-zinc-950/95 shadow-sm" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between border-border/60 border-b bg-black/30 px-3 py-1.5" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1.5 text-[10px] text-zinc-400 uppercase tracking-[0.12em]" }, /* @__PURE__ */ React.createElement(import_lucide_react2.Terminal, { className: "size-3" }), /* @__PURE__ */ React.createElement("span", null, stream ?? label)), /* @__PURE__ */ React.createElement(CopyButton, { label: "Copy", text: body })), /* @__PURE__ */ React.createElement(
    "pre",
    {
...
//# sourceMappingURL=terminal-block.js.map