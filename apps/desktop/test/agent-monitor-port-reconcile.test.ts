...
const PACKAGED_APP =
  "/Applications/ClosedLoop.app/Contents/MacOS/ClosedLoop /Applications/ClosedLoop.app";
const DEV_ELECTRON =
  "/Users/andreweye/ClaudeCode/closedloop-electron-fea-1469/apps/desktop/node_modules/electron/dist/Electron.app/Contents/MacOS/Electron .";
...
const classifyCases: ClassifyCase[] = [
  ...
  {
    label: "packaged app holder → live, even with launchd-like parent",
    holder: { pid: 200, uid: SELF_UID, ppid: 1, command: PACKAGED_APP },
    expected: "live",
  },
  {
    label: "dev Electron app holder → live, never silently orphaned",
    holder: { pid: 200, uid: SELF_UID, ppid: 4242, command: DEV_ELECTRON },
    expected: "live",
  },
];
