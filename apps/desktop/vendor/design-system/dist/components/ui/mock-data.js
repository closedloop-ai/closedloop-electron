...
__export(mock_data_exports, {
  ...
  activityFeedFacets: () => activityFeedFacets,
  ...
  packInstallRun: () => packInstallRun,
  packs: () => packs,
  plans: () => plans,
  policyOverrides: () => policyOverrides,
  pullRequestSessions: () => pullRequestSessions,
  pullRequests: () => pullRequests,
  relayEndpoints: () => relayEndpoints,
  relaySettings: () => relaySettings,
  runSessionRecord: () => runSessionRecord,
  runtimeImportHistory: () => runtimeImportHistory,
  runtimeMaintenanceActions: () => runtimeMaintenanceActions,
  runtimeNotifications: () => runtimeNotifications,
  runtimePricingDraft: () => runtimePricingDraft,
  runtimePricingRules: () => runtimePricingRules,
  runtimeSystemStatus: () => runtimeSystemStatus,
  ...
  sessionConversationTranscript: () => sessionConversationTranscript,
  sessionEventFacets: () => sessionEventFacets,
  sessionEventFilters: () => sessionEventFilters,
  ...
  skills: () => skills,
  subagentDispatches: () => subagentDispatches,
  tabs: () => tabs,
  toolEvents: () => toolEvents,
  toolFacets: () => toolFacets,
  workflowData: () => workflowData,
  workflowSessionDrillIn: () => workflowSessionDrillIn
});
module.exports = __toCommonJS(mock_data_exports);
var import_lucide_react = require("lucide-react");
var tabs = [
  { value: "monitor", label: "Monitor", count: 182, icon: import_lucide_react.Activity },
  { value: "sessions", label: "Sessions", count: 48, icon: import_lucide_react.FolderOpen },
  { value: "activity", label: "Activity", count: 12, icon: import_lucide_react.Workflow },
  { value: "settings", label: "Settings", icon: import_lucide_react.ShieldCheck }
];
var metrics = [
  {
    ...
    trend: "+3 this hour",
    icon: import_lucide_react.FolderOpen
  },
  {
...
var shellRecord = {
  ...
  embedded: false,
  navItems: [
    { id: "dashboard", label: "Dashboard", href: "/", icon: import_lucide_react.LayoutDashboard, active: true },
    { id: "sessions", label: "Sessions", href: "/sessions", icon: import_lucide_react.FolderOpen, badge: 48 },
    { id: "activity", label: "Activity Feed", href: "/activity", icon: import_lucide_react.Activity, badge: 12 },
    { id: "workflows", label: "Workflows", href: "/workflows", icon: import_lucide_react.Workflow },
    { id: "packs", label: "Packs", href: "/packs", icon: import_lucide_react.Package2, badge: 7 },
    {
      id: "pull-requests",
      label: "Pull Requests",
      href: "/pull-requests",
      icon: import_lucide_react.GitPullRequest,
      badge: 18
    },
    { id: "settings", label: "Settings", href: "/settings", icon: import_lucide_react.ShieldCheck }
  ],
  connection: {
    connected: true,
...
var runtimeSystemStatus = [
  {
    ...
    icon: import_lucide_react.Cable,
    tone: "success"
  },
  {
    label: "Hooks",
  ...
  },
  {
    ...
    icon: import_lucide_react.Package2,
    tone: "warning"
  }
];
...
var settingsMetrics = [
  ...
  },
  {
    ...
    icon: import_lucide_react.Workflow
  },
  {
    label: "Security",
    value: "Strict",
