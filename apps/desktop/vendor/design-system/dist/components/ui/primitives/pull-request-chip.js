...
var pull_request_chip_exports = {};
__export(pull_request_chip_exports, {
  PullRequestChip: () => PullRequestChip
});
module.exports = __toCommonJS(pull_request_chip_exports);
...
function PullRequestChip({
  ...
  const content = /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(import_lucide_react.GitPullRequest, { className: "size-3.5" }), /* @__PURE__ */ React.createElement("span", { className: "truncate" }, repo, "#", number));
  if (href) {
...
//# sourceMappingURL=pull-request-chip.js.map