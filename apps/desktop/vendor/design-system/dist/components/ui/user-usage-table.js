...
var user_usage_table_exports = {};
__export(user_usage_table_exports, {
  UserUsageTable: () => UserUsageTable
});
module.exports = __toCommonJS(user_usage_table_exports);
  ...
  if (rows.length === 0) {
    return /* @__PURE__ */ React.createElement(
      EmptyState,
      {
        ...
        icon: import_lucide_react.UserIcon,
...
//# sourceMappingURL=user-usage-table.js.map