...
function AlertDialog({
  ...
  return /* @__PURE__ */ React2.createElement(import_radix_ui2.AlertDialog.Root, { "data-slot": "alert-dialog", ...props });
}
function AlertDialogTrigger({
  ...props
}) {
  return /* @__PURE__ */ React2.createElement(import_radix_ui2.AlertDialog.Trigger, { "data-slot": "alert-dialog-trigger", ...props });
}
function AlertDialogPortal({
  ...props
}) {
  return /* @__PURE__ */ React2.createElement(import_radix_ui2.AlertDialog.Portal, { "data-slot": "alert-dialog-portal", ...props });
}
...
function AlertDialogContent({
  ...
  return /* @__PURE__ */ React2.createElement(AlertDialogPortal, null, /* @__PURE__ */ React2.createElement(AlertDialogOverlay, null), /* @__PURE__ */ React2.createElement(
