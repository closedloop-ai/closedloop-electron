    ...
    import_react_day_picker.DayPicker,
    {
      ...
      components: {
        ...
        Chevron: ({ className: className2, orientation, ...props2 }) => {
          if (orientation === "left") {
            return /* @__PURE__ */ React2.createElement(import_lucide_react.ChevronLeftIcon, { className: cn("size-4", className2), ...props2 });
          }
          ...
          return /* @__PURE__ */ React2.createElement(import_lucide_react.ChevronDownIcon, { className: cn("size-4", className2), ...props2 });
        },
        DayButton: CalendarDayButton,
        WeekNumber: ({ children, ...props2 }) => {
          return /* @__PURE__ */ React2.createElement("td", { ...props2 }, /* @__PURE__ */ React2.createElement("div", { className: "flex size-(--cell-size) items-center justify-center text-center" }, children));
        },
        ...components
      },
      ...props
