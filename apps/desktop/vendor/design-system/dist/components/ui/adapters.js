...
__export(adapters_exports, {
  adaptGroupedRawDashboardEvents: () => adaptGroupedRawDashboardEvents,
  adaptRawDashboardEvent: () => adaptRawDashboardEvent,
  adaptRawTranscriptMessages: () => adaptRawTranscriptMessages,
  adaptRawTranscriptToEnvelopes: () => adaptRawTranscriptToEnvelopes,
  buildEventDetailFromRawEvent: () => buildEventDetailFromRawEvent,
  buildEventTitle: () => buildEventTitle,
  formatGroupDuration: () => formatGroupDuration,
  projectFromRawEvent: () => projectFromRawEvent,
  statusFromEventType: () => statusFromEventType
});
