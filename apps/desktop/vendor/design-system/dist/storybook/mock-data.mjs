...
import { DocumentStatus, PullRequestState } from "@repo/api/src/types/document";
import {
  LoopCommand,
  LoopErrorCode,
  LoopStatus
...
var mockWorkstreamStateOptions = WORKSTREAM_STATE_OPTIONS;
var mockWorkstreamTypeOptions = WORKSTREAM_TYPE_OPTIONS;
