...
var sankey_graph_exports = {};
__export(sankey_graph_exports, {
  SankeyGraph: () => SankeyGraph
});
module.exports = __toCommonJS(sankey_graph_exports);
...
function SankeyGraph({
  ...
  const [size, setSize] = (0, import_react.useState)({ width: 700, height: 420 });
  ...
  const totalUsage = (0, import_react.useMemo)(
  ...
  (0, import_react.useEffect)(() => {
    ...
    const generator = (0, import_d3_sankey.sankey)().nodeId((node) => node.id).nodeWidth(NODE_WIDTH).nodePadding(NODE_PADDING).nodeSort(null).extent([
      [0, 0],
    ...
    const pathGenerator = (0, import_d3_sankey.sankeyLinkHorizontal)();
...
//# sourceMappingURL=sankey-graph.js.map