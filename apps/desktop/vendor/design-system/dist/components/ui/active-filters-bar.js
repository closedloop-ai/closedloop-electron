...
var active_filters_bar_exports = {};
__export(active_filters_bar_exports, {
  ActiveFiltersBar: () => ActiveFiltersBar
});
module.exports = __toCommonJS(active_filters_bar_exports);
...
function DropdownMenuPortal({
  ...
  return /* @__PURE__ */ React3.createElement(import_radix_ui2.DropdownMenu.Portal, { "data-slot": "dropdown-menu-portal", ...props });
}
...
function DropdownMenuGroup({
  ...
  return /* @__PURE__ */ React3.createElement(import_radix_ui2.DropdownMenu.Group, { "data-slot": "dropdown-menu-group", ...props });
}
...
function DropdownMenuSub({
  ...
  return /* @__PURE__ */ React3.createElement(import_radix_ui2.DropdownMenu.Sub, { "data-slot": "dropdown-menu-sub", ...props });
}
function DropdownMenuSubTrigger({
  ...
  return /* @__PURE__ */ React3.createElement(
    ...
    children,
    /* @__PURE__ */ React3.createElement(import_lucide_react.ChevronRightIcon, { className: "ml-auto size-4" })
  );
}
...
function Checkbox({
  ...
  return /* @__PURE__ */ React5.createElement(
    ...
    /* @__PURE__ */ React5.createElement(
      ...
      /* @__PURE__ */ React5.createElement(import_lucide_react3.CheckIcon, { className: "size-3 group-data-[state=indeterminate]/checkbox:hidden", strokeWidth: 3 }),
      /* @__PURE__ */ React5.createElement(import_lucide_react3.MinusIcon, { className: "hidden size-3 group-data-[state=indeterminate]/checkbox:block", strokeWidth: 3 })
    )
  );
}
...
function FilterMenuContent({
  ...
  return /* @__PURE__ */ React.createElement(DropdownMenuContent, { align: "start", className: "w-52" }, /* @__PURE__ */ React.createElement(DropdownMenuGroup, null, !viewModel.hideAssignee && viewModel.currentUser && /* @__PURE__ */ React.createElement(
    ...
    filters.assignToMe && /* @__PURE__ */ React.createElement(import_lucide_react4.CheckIcon, { className: "ml-auto size-4" })
  ), /* @__PURE__ */ React.createElement(
    DropdownMenuItem,
    {
      onSelect: (event) => {
    ...
    /* @__PURE__ */ React.createElement(import_lucide_react4.EyeOffIcon, { className: "size-4" }),
    /* @__PURE__ */ React.createElement("span", { className: cn(filters.hideCompletedItems && "font-medium") }, labels.hideCompletedItems),
    filters.hideCompletedItems && /* @__PURE__ */ React.createElement(import_lucide_react4.CheckIcon, { className: "ml-auto size-4" })
  ), /* @__PURE__ */ React.createElement(
    DropdownMenuItem,
    {
      onSelect: (event) => {
    ...
    /* @__PURE__ */ React.createElement(import_lucide_react4.StarIcon, { className: "size-4" }),
    /* @__PURE__ */ React.createElement("span", { className: cn(filters.favoritesOnly && "font-medium") }, labels.favoritesOnly),
    filters.favoritesOnly && /* @__PURE__ */ React.createElement(import_lucide_react4.CheckIcon, { className: "ml-auto size-4" })
...
function DateFilterContent({
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, presets.map((preset) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      selected && /* @__PURE__ */ React.createElement(import_lucide_react4.CheckIcon, { className: "ml-auto size-4" })
    );
  }));
}
...
function AssigneeSubmenu({
  ...
  return /* @__PURE__ */ React.createElement(DropdownMenuSub, null, /* @__PURE__ */ React.createElement(DropdownMenuSubTrigger, null, /* @__PURE__ */ React.createElement(import_lucide_react4.UsersIcon, { className: "size-4" }), /* @__PURE__ */ React.createElement("span", { className: "flex-1" }, labels.assignee), controller.filters.assigneeIds.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-muted-foreground text-xs" }, controller.filters.assigneeIds.length)), /* @__PURE__ */ React.createElement(DropdownMenuPortal, null, /* @__PURE__ */ React.createElement(DropdownMenuSubContent, { className: "w-64" }, /* @__PURE__ */ React.createElement(AssigneeFilterContent, { controller, viewModel }))));
}
function DatesSubmenu({
  ...
  return /* @__PURE__ */ React.createElement(DropdownMenuSub, null, /* @__PURE__ */ React.createElement(DropdownMenuSubTrigger, null, /* @__PURE__ */ React.createElement(import_lucide_react4.CalendarIcon, { className: "size-4" }), /* @__PURE__ */ React.createElement("span", { className: "flex-1" }, labels.dates), controller.filters.date && /* @__PURE__ */ React.createElement("span", { className: "text-muted-foreground text-xs" }, "1")), /* @__PURE__ */ React.createElement(DropdownMenuPortal, null, /* @__PURE__ */ React.createElement(DropdownMenuSubContent, { className: "w-48" }, /* @__PURE__ */ React.createElement(
    DateFieldSubmenu,
    {
      controller,
      datePresetOptions,
...
function DateFieldSubmenu({
  ...
  return /* @__PURE__ */ React.createElement(DropdownMenuSub, null, /* @__PURE__ */ React.createElement(DropdownMenuSubTrigger, null, /* @__PURE__ */ React.createElement(import_lucide_react4.CalendarIcon, { className: "size-4" }), /* @__PURE__ */ React.createElement("span", { className: "flex-1" }, label)), /* @__PURE__ */ React.createElement(DropdownMenuPortal, null, /* @__PURE__ */ React.createElement(DropdownMenuSubContent, { className: "w-44" }, /* @__PURE__ */ React.createElement(
    DateFilterContent,
    {
      controller,
      datePresetOptions,
...
function TagsSubmenu({
  ...
  return /* @__PURE__ */ React.createElement(DropdownMenuSub, null, /* @__PURE__ */ React.createElement(DropdownMenuSubTrigger, null, /* @__PURE__ */ React.createElement(import_lucide_react4.TagIcon, { className: "size-4" }), /* @__PURE__ */ React.createElement("span", { className: "flex-1" }, labels.tags), selectedTagIds.length > 0 && /* @__PURE__ */ React.createElement("span", { className: "text-muted-foreground text-xs" }, selectedTagIds.length)), /* @__PURE__ */ React.createElement(DropdownMenuPortal, null, /* @__PURE__ */ React.createElement(DropdownMenuSubContent, { className: "w-56" }, options.length === 0 ? /* @__PURE__ */ React.createElement(DropdownMenuItem, { disabled: true }, labels.noTags) : options.map((tag) => /* @__PURE__ */ React.createElement(
    FilterRow,
    {
...
function ActiveFiltersBar({
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap items-center gap-1 px-4 pb-2" }, visibleChips.map((chip) => /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(import_lucide_react5.PlusIcon, { className: "size-3.5" })
...
//# sourceMappingURL=active-filters-bar.js.map